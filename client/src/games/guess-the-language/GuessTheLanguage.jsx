...
function GuessTheLanguage() {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL}/api/questions/languages`, {
...
function ClassicRunner({ questions, questionTime }) {
  ...
  if (quiz.status === 'finished') {
    return <Results score={quiz.score} total={quiz.total} history={quiz.history} gameTitle="Guess the Language" />;
  }
  return (
    <QuizLayout
      {...quiz}
      onAnswer={quiz.handleAnswer}
      gameTitle="Guess the Language"
